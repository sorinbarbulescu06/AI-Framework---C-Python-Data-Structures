...
def train(input_data, output_data, model_type):
    global INPUT_NO, OUTPUT_NO, TESTS_NO, EXAM_NO #global data
    ...
    for model in presets:
        ...
        train_lib.train_and_test(INPUT_NO, OUTPUT_NO, model.depth, 10, model.ponders, flat_input, flat_output, EXAM_NO, point_height)
